                                    ...
                                    <table class="table table-bordered text-center">
                                        <tbody>
                                            <tr class=" border-top border-bottom">
                                                ...
                                                <td class="text-start px-3" colspan="5">${gallery.title}</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr class="text-start">
                                                <td colspan="6">
                                                    ...
                                                    <c:if test="${not empty gallery.img}">
                                                        <br><img src="/uploads/gallery/${gallery.img}" style="max-width: 100%; height: auto;">
                                                    </c:if>
                                                </td>
                                            </tr>
                                        </tbody>
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="text-start">
                                                <td colspan="2">
                                                    ${gallery.content}
                                                    <c:if test="${not empty gallery.img}">
                                                        <br><img src="/uploads/gallery/${gallery.img}" width="100%">
                                                    </c:if>
                                                </td>
                                            </tr>
                                        </tbody>
