...
<body>
                    ...
                    <div class="banner-content">
                        <div class="page-path">
                            <ul>
                                ...
                                <li><a href="board">관전후기</a></li>
                                <li><a class="current-page" href="#">상세보기</a></li>
                            </ul>
                        </div>
                        <h1 class="banner-heading">관전후기 상세</h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="rts-blog-details-area section-gap">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <div class="blog-details-inner">
                        <div class="blog-details-content">
                            <div class="blog-meta">
                                <span class="author">by ${gallery.name}</span>
                                <span class="date">${gallery.regdate}</span>
                            </div>
                ...
                <div class="col-lg-4">
                    <div class="blog-sidebar">
                        <div class="widget">
                            <h4 class="widget-title">관전후기 목록</h4>
