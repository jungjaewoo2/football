                        ...
                        <div class="row r-content-2">
                            <div class="mt-3">
                                    ...
                                    <table class="table table-bordered text-center">
                                        <tbody>
                                            <tr class=" border-top border-bottom">
                                                ...
                                                <td class="text-start px-3" colspan="5">[2024-2025 EPL] 맨시티 vs 첼시, 토트넘 vs 레스터시티 경기 관전후기</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr class="text-start">
                                                <td colspan="6">
                                                    1.21 ~ 29까지 영국 여행을 한 고태화입니다.<br>
                                                    저는 맨시티 팬이고 자칭 축구에 미친사람이라....여러경기를 보고싶은데<br>
                                                    방법을 모르겠어서 찾게 되었습니다.<br>
                                                    <img src="assets/images/event/event-detail-img01.jpg">
                                                    <img src="assets/images/event/event-detail-img02.jpg"><br>
                                                    영국에 가서 드디어 기대하던 경기를 보는 순간<br>
                                                    집에서 경기를 보는 것과는 비교 자체가 안될 정도로 현장에서 보는것이 훨씬 좋았습니다. 특히 게이트로 들어가면서 그라운드가 점점 보여지고 음악이 함께 들릴 때 잊지 못할 추억이었고 선수들도 거의 1열에서 보았기 때문에 정말 좋았습니다. 저희는 2경기를 보았는데 총 골이 많이 나와서 경기 하나하나가 정말 흥미진진 했으며 전혀 돈이 아깝지 않았습니다.<br>
                                                    혹시 티켓을 구하는 것이 어렵거나 유럽 여행이 처음이신 분들은 프리미어티켓을 통해 가시는 것을 추천드립니다.<br>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                ...
                                <div class="d-block d-lg-none">
                                    <table class="table table-bordered">
                                        <tbody>
                                            <tr class="border-top border-bottom">
                                                <th class="bg-light">제목</th>
                                                <td>[2024-2025 EPL] 맨시티 vs 첼시, 토트넘 vs 레스터시티 경기 관전후기</td>
                                            </tr>
                                            <tr>
                                                <th class="bg-light">작성자</th>
                                                <td>고태화</td>
                                            ...
                                            <tr class="text-start">
                                                <td colspan="2">
                                                    ...
                                                    저는 맨시티 팬이고 자칭 축구에 미친사람이라....여러경기를 보고싶은데<br>
                                                    방법을 모르겠어서 찾게 되었습니다.<br>
                                                    <img src="assets/images/event/event-detail-img01.jpg" width="100%"><br>
                                                    <img src="assets/images/event/event-detail-img02.jpg" width="100%"><br>
                                                    영국에 가서 드디어 기대하던 경기를 보는 순간<br>
                                                    집에서 경기를 보는 것과는 비교 자체가 안될 정도로 현장에서 보는것이 훨씬 좋았습니다. 특히 게이트로 들어가면서 그라운드가 점점 보여지고 음악이 함께 들릴 때 잊지 못할 추억이었고 선수들도 거의 1열에서 보았기 때문에 정말 좋았습니다. 저희는 2경기를 보았는데 총 골이 많이 나와서 경기 하나하나가 정말 흥미진진 했으며 전혀 돈이 아깝지 않았습니다.<br>
                                                    혹시 티켓을 구하는 것이 어렵거나 유럽 여행이 처음이신 분들은 프리미어티켓을 통해 가시는 것을 추천드립니다.<br>
                                                </td>
                                ...
                                <div class="d-flex gap-1 justify-content-between mt--10">
                                    <button type="submit" class="btn btn-secondary rounded-pill" onclick="location.href='board.html'">목록</button>
                               </div>
                            </div>
                        </div>
