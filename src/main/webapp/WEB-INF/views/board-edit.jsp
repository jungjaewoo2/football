                            ...
                            <div class="">
                                ...
                                <div class="d-flex gap-1 justify-content-between mt--10">
                                    ...
                                    <div class="d-flex gap-1 justify-content-end">
                                        <button type="submit" class="btn btn-danger rounded-pill" onclick="location.href='board-detail.html'">저장</button>
                                        <button type="submit" class="btn btn-dark rounded-pill" onclick="location.href='board-detail.html'">취소</button>
                                    </div>
                                </div>
                            </div>
                        </div>
