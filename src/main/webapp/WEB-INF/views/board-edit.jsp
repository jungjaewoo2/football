                        ...
                        <div class="row r-content-2">
                            <div class="">
                                    ...
                                    <table class="table table-bordered text-center">
                                        <tbody>
                                            <tr class=" border-top border-bottom">
                                                ...
                                                <td class="text-start px-3" colspan="5"><input type="text" class="form-control" id="exampleFormControlInput1" placeholder="[2024-2025 EPL] 맨시티 vs 첼시, 토트넘 vs 레스터시티 경기 관전후기"></td>
                                            </tr>
                                            <tr>
                                                <th class="bg-light px-3">작성자</th>
                                                <td class="px-3">고태화</td>
                                                <th class="bg-light px-3">작성일</th>
                                                <td class="px-3">2025-02-20</td>
                                ...
                                <div class="d-flex gap-1 justify-content-between mt--10">
                                    <button type="submit" class="btn btn-secondary rounded-pill" onclick="location.href='board'">목록</button>
                                    <div class="d-flex gap-1 justify-content-end">
                                        <button type="submit" class="btn btn-danger rounded-pill" onclick="location.href='board-detail'">저장</button>
                                        <button type="submit" class="btn btn-dark rounded-pill" onclick="location.href='board-detail'">취소</button>
                                    </div>
                                </div>
                            </div>
                        </div>
