                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form action="/ticket-qna-password" method="post" onsubmit="return validateForm()">
                                    ...
                                    <div class="d-grid gap-2">
                                        ...
                                        <button type="button" class="btn btn-secondary" onclick="location.href='/ticket-qna'">목록으로</button>
                                    </div>
                                </form>
                            </div>
                        </div>
