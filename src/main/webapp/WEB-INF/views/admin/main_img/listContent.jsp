            ...
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <c:if test="${totalPages >= 1}">
                        <nav aria-label="메인 이미지 페이지 네비게이션">
                            <ul class="pagination justify-content-center">
                                <!-- 처음 페이지 버튼 -->
                                <li class="page-item ${currentPage == 0 ? 'disabled' : ''}">
                                    <a class="page-link" href="/admin/main_img/list?page=0">
                                ...
                                <c:forEach begin="${startPage}" end="${endPage}" var="pageNum">
                                    <li class="page-item ${pageNum == currentPage ? 'active' : ''}">
                                        <a class="page-link" href="/admin/main_img/list?page=${pageNum}">
                                            ${pageNum + 1}
                                        </a>
                                    </li>
                                </c:forEach>
                                ...
                                <!-- 마지막 페이지 버튼 -->
                                <li class="page-item ${currentPage >= totalPages - 1 ? 'disabled' : ''}">
                                    <a class="page-link" href="/admin/main_img/list?page=${totalPages - 1}">
                        ...
                        <div class="text-center text-muted">
                            총 ${totalElements}개의 메인 이미지 중 ${(currentPage * 10) + 1} - ${Math.min((currentPage + 1) * 10, totalElements)}개 표시
                        </div>
                    </c:if>
                </c:otherwise>
            </c:choose>
