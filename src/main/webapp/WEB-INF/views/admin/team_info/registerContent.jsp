...
<div class="content-card">
    <div class="content-header">
        <h2><i class="fas fa-plus-circle me-2"></i>새 팀정보 등록</h2>
        <p>축구팀 정보를 등록해주세요.</p>
    </div>
    ...
    <form method="POST" action="/admin/team_info/register" id="teamInfoForm" enctype="multipart/form-data">
        <div class="row">
            <!-- 팀구단명 -->
            <div class="col-12 mb-3">
                ...
                <input type="text" class="form-control" id="teamName" name="teamName" 
                       placeholder="예: Manchester United, Real Madrid" required>
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" id="stadium" name="stadium" 
                       placeholder="예: Old Trafford, Santiago Bernabéu">
