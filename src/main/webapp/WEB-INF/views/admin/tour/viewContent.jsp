...
<div class="content-card">
    <div class="content-header">
        <h2><i class="fas fa-futbol me-2"></i>유로풋볼투어 관리</h2>
        <p>유로풋볼투어 내용을 확인하고 수정할 수 있습니다.</p>
    </div>
    <c:if test="${not empty success}">
        <div class="alert alert-success">
            <i class="fas fa-check-circle me-2"></i>
            <c:choose>
                <c:when test="${success eq 'success'}">유로풋볼투어가 성공적으로 수정되었습니다.</c:when>
    ...
    <div class="card mb-4">
        <div class="card-header bg-primary text-white">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="mb-0">
                    <i class="fas fa-futbol me-2"></i>유로풋볼투어 내용
                </h5>
                <div class="btn-group">
                    <a href="/admin/tour/edit" class="btn btn-light btn-sm">
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        <div class="text-center py-4">
                            ...
                            <p class="text-muted">등록된 유로풋볼투어 내용이 없습니다.</p>
                            <a href="/admin/tour/edit" class="btn btn-primary">
                                <i class="fas fa-plus me-1"></i>유로풋볼투어 내용 등록하기
                            </a>
                        </div>
                    </c:otherwise>
                </c:choose>
