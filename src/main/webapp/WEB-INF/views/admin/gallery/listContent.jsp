...
<div class="content-card">
                                ...
                                <td class="text-center">
                                    <c:choose>
                                        <c:when test="${gallery.regdate != null}">
                                            <c:set var="regdateStr" value="${gallery.regdate}" />
                                            <c:choose>
    ...
    <c:if test="${totalPages >= 1}">
        <nav aria-label="Gallery 페이지 네비게이션">
            <ul class="pagination justify-content-center">
                ...
                <li class="page-item ${currentPage == 0 ? 'disabled' : ''}">
                    <a class="page-link" href="/admin/gallery/list?page=0&searchType=${searchType}&keyword=${keyword}">
                ...
                <!-- 마지막 페이지 버튼 -->
                <li class="page-item ${currentPage >= totalPages - 1 ? 'disabled' : ''}">
                    <a class="page-link" href="/admin/gallery/list?page=${totalPages - 1}&searchType=${searchType}&keyword=${keyword}">
        ...
        <div class="text-center text-muted">
            총 ${totalItems}개의 관전후기 중 ${(currentPage * 10) + 1} - ${Math.min((currentPage + 1) * 10, totalItems)}개 표시
        </div>
    </c:if>
</div>
