...
<div class="content-card">
    <div class="content-header">
        <h2><i class="fas fa-user-shield me-2"></i>개인정보 관리</h2>
        <p>개인정보처리방침 내용을 확인하고 수정할 수 있습니다.</p>
    </div>
    ...
    <div class="card mb-4">
        <div class="card-header bg-primary text-white">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="mb-0">
                    <i class="fas fa-user-shield me-2"></i>개인정보처리방침 내용
                </h5>
                <div class="btn-group">
                    <a href="/admin/person/edit" class="btn btn-light btn-sm">
        ...
        <div class="card-body">
            <div class="content-area">
                <c:choose>
                    <c:when test="${not empty person.content}">
                        <div class="ck-content">
                            ${fn:replace(person.content, newLine, '<br>')}
                        </div>
                    </c:when>
                    <c:otherwise>
                        <div class="text-center py-4">
                            <i class="fas fa-user-shield fa-2x text-muted mb-2"></i>
                            <p class="text-muted">등록된 개인정보처리방침 내용이 없습니다.</p>
                            <a href="/admin/person/edit" class="btn btn-primary">
                                <i class="fas fa-plus me-1"></i>개인정보처리방침 내용 등록하기
                            </a>
                        </div>
                    </c:otherwise>
                </c:choose>
