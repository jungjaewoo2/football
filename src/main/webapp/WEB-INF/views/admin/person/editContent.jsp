        ...
        upload() {
            return this.loader.file.then(file => {
                return new Promise((resolve, reject) => {
                    ...
                    fetch('/admin/upload/person/image', {
                        method: 'POST',
                        body: formData
                    })
                    .then(response => {
...
.person-content .image.image-style-align-left,
.person-content .image-style-align-left,
...
.person-content .image.image-style-align-right,
.person-content .image-style-align-right,
...
.person-content .image.image-style-align-center,
.person-content .image-style-align-center,
...
.person-content .image.image-style-block,
.person-content .image-style-block,
...
.person-content figure.image img,
.content-display figure.image img {
    display: block;
}

.person-content figure.image.image-style-align-left,
.content-display figure.image.image-style-align-left {
    float: left;
    margin: 0 1.5em 1em 0;
}

.person-content figure.image.image-style-align-right,
.content-display figure.image.image-style-align-right {
    float: right;
    margin: 0 0 1em 1.5em;
}

.person-content figure.image.image-style-align-center,
