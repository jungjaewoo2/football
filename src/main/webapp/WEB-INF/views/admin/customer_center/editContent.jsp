...
<div class="content-card">
    <div class="content-header">
        <h2><i class="fas fa-edit me-2"></i>고객센터 수정</h2>
        <p>고객센터 내용을 수정할 수 있습니다. 웹에디터를 통해 이미지 첨부가 가능합니다.</p>
    </div>
    ...
    <div class="card">
        <div class="card-header bg-warning text-dark">
            <h5 class="mb-0">
                <i class="fas fa-headset me-2"></i>고객센터 내용 수정
            </h5>
        </div>
        <div class="card-body">
            <form id="customerCenterForm" method="post" action="/admin/customer_center/edit">
                <div class="mb-3">
                    <label for="content" class="form-label">
                        <i class="fas fa-edit me-1"></i>고객센터 내용
                    </label>
                    <textarea id="content" name="content" class="form-control" style="display: none;"
                              placeholder="고객센터 내용을 입력하세요. 이미지 첨부가 가능합니다.">${customerCenter.content}</textarea>
                ...
                <div class="d-flex justify-content-between">
                    <a href="/admin/customer_center" class="btn btn-secondary">
...
<script>
        ...
        upload() {
            return this.loader.file.then(file => {
                return new Promise((resolve, reject) => {
                    ...
                    fetch('/admin/upload/customer-center/image', {
                        method: 'POST',
                        body: formData
                    })
                    .then(response => {
    ...
    // 폼 제출 처리
    document.addEventListener('DOMContentLoaded', function() {
        document.getElementById('customerCenterForm').addEventListener('submit', function(e) {
            console.log('폼 제출 시작');
...
.customer-center-content .image img,
...
.customer-center-content .image-inline,
...
.customer-center-content .image-side,
...
.customer-center-content .image.image-style-align-left,
.customer-center-content .image-style-align-left,
...
.customer-center-content .image.image-style-align-right,
.customer-center-content .image-style-align-right,
...
.customer-center-content .image.image-style-align-center,
.customer-center-content .image-style-align-center,
...
.customer-center-content .image.image-style-block,
.customer-center-content .image-style-block,
...
/* figure 요소에 대한 스타일 */
.customer-center-content figure.image,
.content-display figure.image {
    display: table;
}

.customer-center-content figure.image img,
.content-display figure.image img {
    display: block;
}

.customer-center-content figure.image.image-style-align-left,
.content-display figure.image.image-style-align-left {
    float: left;
    margin: 0 1.5em 1em 0;
}

.customer-center-content figure.image.image-style-align-right,
.content-display figure.image.image-style-align-right {
    float: right;
    margin: 0 0 1em 1.5em;
}

.customer-center-content figure.image.image-style-align-center,
...
/* 이미지 캡션 스타일 */
.customer-center-content figcaption,
