...
<div class="content-card">
    ...
    <!-- 등록 폼 -->
    <form method="POST" action="/admin/ticket_link/register" enctype="multipart/form-data">
        <div class="row">
            <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <input type="file" class="form-control" id="ticketImg" name="ticketImg" 
                   accept="image/*">
            <small class="form-text text-muted">이미지 파일만 업로드 가능합니다. (JPG, PNG, GIF 등) 이미지 240*260 적정크기</small>
        </div>
        
        <div class="form-group">
            <label for="link">링크 주소</label>
