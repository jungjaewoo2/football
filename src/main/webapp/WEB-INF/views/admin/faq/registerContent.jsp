...
<div class="content-card">
    <div class="content-header">
        <h2><i class="fas fa-plus me-2"></i>FAQ 등록</h2>
        <p>새로운 FAQ를 등록합니다. 웹에디터를 통해 이미지 첨부가 가능합니다.</p>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            <form action="/admin/faq/register" method="post" id="faqForm">
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                ...
                <div class="d-flex justify-content-end gap-2">
                    <a href="/admin/faq/list" class="btn btn-outline-secondary">
