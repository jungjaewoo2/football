...
<div class="content-card">
    <div class="content-header">
        <h2><i class="fas fa-file-contract me-2"></i>약관 관리</h2>
        <p>약관 내용을 확인하고 수정할 수 있습니다.</p>
    </div>
    ...
    <div class="card mb-4">
        <div class="card-header bg-primary text-white">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="mb-0">
                    <i class="fas fa-file-contract me-2"></i>약관 내용
                </h5>
                <div class="btn-group">
                    <a href="/admin/tsc/edit" class="btn btn-light btn-sm">
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        <div class="text-center py-4">
                            ...
                            <p class="text-muted">등록된 약관 내용이 없습니다.</p>
                            <a href="/admin/tsc/edit" class="btn btn-primary">
                                <i class="fas fa-plus me-1"></i>약관 내용 등록하기
                            </a>
                        </div>
                    </c:otherwise>
                </c:choose>
