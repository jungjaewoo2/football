...
<div class="content-card">
    <div class="content-header">
        <h2><i class="fas fa-edit me-2"></i>약관 수정</h2>
        <p>약관 내용을 수정할 수 있습니다. 웹에디터를 통해 이미지 첨부가 가능합니다.</p>
    </div>
    ...
    <div class="card">
        <div class="card-header bg-warning text-dark">
            <h5 class="mb-0">
                <i class="fas fa-file-contract me-2"></i>약관 내용 수정
            </h5>
        </div>
        <div class="card-body">
            <form id="tscForm" method="post" action="/admin/tsc/edit">
                <div class="mb-3">
                    <label for="content" class="form-label">
                        <i class="fas fa-edit me-1"></i>약관 내용
                    </label>
                    <textarea id="content" name="content" class="form-control" style="display: none;"
                              placeholder="약관 내용을 입력하세요. 이미지 첨부가 가능합니다.">${tsc.content}</textarea>
                ...
                <div class="d-flex justify-content-between">
                    <a href="/admin/tsc" class="btn btn-secondary">
...
<script>
    ...
    // 폼 제출 처리
    document.addEventListener('DOMContentLoaded', function() {
        document.getElementById('tscForm').addEventListener('submit', function(e) {
            console.log('폼 제출 시작');
...
.tsc-content .image.image-style-align-left,
.tsc-content .image-style-align-left,
...
.tsc-content .image.image-style-align-right,
.tsc-content .image-style-align-right,
...
.tsc-content .image.image-style-align-center,
.tsc-content .image-style-align-center,
...
.tsc-content .image.image-style-block,
.tsc-content .image-style-block,
...
/* figure 요소에 대한 스타일 */
.tsc-content figure.image,
.content-display figure.image {
    display: table;
}

.tsc-content figure.image img,
.content-display figure.image img {
    display: block;
}

.tsc-content figure.image.image-style-align-left,
.content-display figure.image.image-style-align-left {
    float: left;
    margin: 0 1.5em 1em 0;
}

.tsc-content figure.image.image-style-align-right,
.content-display figure.image.image-style-align-right {
    float: right;
    margin: 0 0 1em 1.5em;
}

.tsc-content figure.image.image-style-align-center,
