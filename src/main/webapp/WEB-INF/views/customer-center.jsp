                    ...
                    <div class="banner-content">
                        <div class="page-path">
                            <ul>
                                ...
                                <li><a class="current-page" href="#">CUSTOMER CENTER</a></li>
                            </ul>
                        </div>
                        <h1 class="banner-heading">고객센터</h1>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row d-flex">
                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="row r-content-2">
                            <div>
                                <div class="align-items-center d-flex fs-4 fw-bold gap-3 mb--40 px-2" style="border-top: 5px solid #333869;background: gold;color: #333869">최저 가격 <span class="text-white fs-1 fw-bold text-decoration-underline" style="">Lowest Price</span></div>
                                <p><img src="assets/images/img/customer-img01.png"></p><br>
                                <p>- 가격 때문에 이곳 저곳 헤매지 마십시오.</p>
                                <p>- 티켓 에이전시에도 등급이 있습니다.</p>
                                <p>- 최저가격이 아니면 차액만큼 보상</p>
                            </div><br>
                            <div>
                                1. 비교 대상 티켓 대행사 : 정식으로 등록된 에이전시(외국회사포함)라면 어디든 가능합니다.<br>
                                2. 비교 대상 티켓 종류 : 영국 프리미어 리그만을 대상으로 합니다.(챔피언스 리그, FA컵 및 친선 경기 등은 제외)<br>
                                3. 비교방법 : 타 싸이트에서 견적 받은 내용을 게시판 또는 이메일로 보내주시면 됩니다.<br>
                                4. 보상신고 기간 : 구입 또는 견적 받은 시점이 일주일 이내이어야 합니다.<br>
                                5. 보상 방법 : 담담자 접수 후 보상결정이 내려진 티켓에 대해 그 주 금요일에 고객의 구좌로 지급<br>
                                6. 주의사항 : 가격할인 쿠폰이나 주문금액 할인쿠폰은 비교 대상에서 제외됩니다.
                            </div><br>
                            <div>
                                <div class="align-items-center d-flex fs-4 fw-bold gap-3 mb--15 px-2" style="border-top: 5px solid #333869;background: gold;color: #333869">예약&amp;결제 <span class="text-white fs-1 fw-bold text-decoration-underline" style="">Reservation&amp;</span></div><br>
                                <p>- 경기에 대한 문의는 24시간 게시판 및 전화, 메일로 가능합니다.</p>
                                <p>- 예약은 예약 게시판과 전화로 가능합니다.</p>
                            </div><br>
                            <div>
                                <div class="fw-bold fs-5"><i class="fad fa-check-circle text-orange"></i> 결제</div><br>
                                1. 신용카드 : 영국에서 결제가 되므로 해외에서 사용 가능한 VISA또는 MasterCard를 이용해 주세요.<br><br>
                                - 프리미어리그 티켓은 페이팔(paypal) 결제 시스템을 이용하여 결제를 진행할 수 있습니다.<br>
                                - 신용카드 결제를 위해서 페이팔 계정 생성 및 주 사용카드 등록이 필요합니다.<br>
                                - 카드결제 문의사항은 고객센터로 연락 바랍니다.<br><br>
                                2. 영국 송금 계좌 번호 (카카오뱅크 등 해외 송금을 쉽게 진행할 수 있습니다) 예약 시 추가 안내 드립니다.<br><br>
                                <div class="fw-bold fs-5"><i class="fad fa-check-circle text-orange"></i> 환불규정</div><br>
                                * 입금 후 관전을 취소할 경우 아래의 비율로 취소 위약금을 부과함을 알려드립니다.<br><br>
                                * 주최 측 사정으로 경기가 연기 될 경우 50% 즉시 환불 또는 (미 확정 일정 포함)연기 된 날짜로 변경 할 수 있습니다.<br>
                                - 이 경우 하기 환불 규정이 적용 되지 않습니다. (예) 여왕 서거로 인한 무기한 연기<br><br>
                                * 취소 접수는 업무 시간 내 접수 및 확인이 가능합니다.<br>
                                - (예) 평일 금요일 업무 종료 전까지 취소 하셔야 합니다. (주말 및 공휴일 취소 신청 및 적용 불가)<br><br>
                                ...
                                - 시합일 통보 시 : 전액 환불 불가<br><br>

                                <div class="fw-bold fs-5"><i class="fad fa-check-circle text-orange"></i> 티켓수령</div><br>
                                - 대부분의 경기 티켓은 경기 당일로부터 1~2일 내 메일로 e티켓이 전달 됩니다.<br>
                                - 일부 경기의 경우 수령 및 반납이 필요한 전자카드로 진행 될 수 있으며 이 경우 추가 안내 드립니다.
                            </div>
                        </div>
                    </div>
                </div>
