                        ...
                        <div class="row r-content-2">
                            <div class="mt-3">
                                    ...
                                    <table class="table table-bordered text-center">
                                        <tbody>
                                            <tr class=" border-top border-bottom">
                                                ...
                                                <td class="text-start px-3" colspan="3">2매 이상 예약 시 좌석은 어떤 형식으로 구성 되나요?</td>
                                            </tr>
                                            <tr>
                                ...
                                <div class="d-block d-lg-none">
                                    <table class="table table-bordered">
                                        <tbody>
                                            <tr class="border-top border-bottom">
                                                <th class="bg-light">제목</th>
                                                <td>2매 이상 예약 시 좌석은 어떤 형식으로 구성 되나요?</td>
                                            </tr>
                                            <tr>
                                                <th class="bg-light">작성일</th>
                                                <td>2025-02-04</td>
                                ...
                                <div class="d-flex gap-1 justify-content-between mt--10">
                                    <button type="submit" class="btn btn-secondary rounded-pill" onclick="location.href='faq.html'">목록</button>
                                </div>
                            </div>
                        </div>
