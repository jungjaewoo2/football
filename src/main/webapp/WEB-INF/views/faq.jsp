                ...
                <div class="row d-flex">
                    ...
                    <!--<div class="col-lg-9">
                        ...
                        <div class="row r-content-2">
                            <img src="assets/images/img/faq-img.jpg">
                            <div class="mt-3">
                                <div class="faq-que-list faq-que2 mb-30">
                                    <div class="accordion" id="accordionExample">
                                        <div class="accordion-item">
                                            <h2 class="accordion-header" id="headingOne">
                                                <button class="accordion-button align-items-lg-center align-items-start d-flex flex-column flex-lg-row" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                                    <div class="accord-btn">공지</div> <span class="accord-header">2매 이상 예약 시 좌석은 어떤 형식으로 구성 되나요?</span>
                                                </button>
                                            </h2>
                                            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                                <div class="accordion-body">
                                                    <p class="fs-14">
                                                        안녕하세요. 프리미어티켓을 이용해 주셔서 감사합니다.<br><br>
                                                        프리미어티켓에서는 최대한 기본 2연석 구성으로 확보에 주력하며 ,실제 95% 이상의 티켓은 연석으로 확보되고 있습니다.<br>
                                                        단, 일부 경기 또는 임박한 날짜에 예약한 좌석은 대체 좌석으로 확보 될 수 있다는 점 양해 부탁드립니다.
                                                    </p><br>
                                                    <p>
                                                        〈 프리미어티켓 기본 2연석 및 3~4연석 좌석구성 〉
                                                        <img src="assets/images/img/153218_81EAB0A1EC95.jpg">
                                                    </p><br>
                                                    <p>
                                                        〈 프리미어티켓 대체 2연석 좌석구성 〉
                                                        <img src="assets/images/img/153416_297EC9DEC9CA229_81EAB0A1EC95.jpg">
                                                    </p><br>
                                                    <p>
                                                        〈 프리미어티켓 대체 3연석~4연석 좌석구성 〉
                                                        <img src="assets/images/img/153448_B5EC85EDACB8ECB0A029.jpg">
                                                    </p><br>
                                                    <p>감사합니다.<br>프리미어티켓 올림</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="accordion-item">
                                            <h2 class="accordion-header" id="headingTwo">
                                                <button class="accordion-button collapsed align-items-lg-center align-items-start d-flex flex-column flex-lg-row" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                                    <div class="accord-btn">공지</div> <span class="accord-header">페이팔(paypal) 신용카드 결제 안내</span>
                                                </button>
                                            </h2>
                                            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                                <div class="accordion-body">
                                                    <p class="fs-14">
                                                        페이팔(paypal)은 프리미어티켓에서 이용하고 있는 간편결제 시스템입니다.<br>
                                                        페이팔은 구매자와 해외 판매자 사이를 연결해 주는 간편결제(에스크로 서비스) 시스템으로,<br>
                                                        프리미어티켓에서 제공하는 서비스를 안전하게 구매할 수 있습니다.<br>
                                                        페이팔 결제는 프리미어티켓에서 발송하는 결제 안내 메일을 고객님이 확인 후 직접 카드 정보를 입력하는 방식으로 진행됩니다.<br>
                                                        결제 방법은 하기 이미지 및 안내를 참고 바랍니다.<br>
                                                    </p><br>
                                                    <p>
                                                        <img src="assets/images/img/111200_00700.jpg">
                                                    </p><br>
                                                    <p>
                                                        페이팔 결제에 대한 문의사항은 언제든 연락을 부탁드립니다.<br>
                                                        결제 완료 후 결제 여부를 담당자에게 전달 주시면 보다 빠른 진행이 가능합니다.<br>
                                                        (참고: 페이팔 코리아 공식 홈페이지) <a class="text-decoration-underline text-info" href="https://www.paypal.com/kr/home" target="_blank">https://www.paypal.com/kr/home</a><br>
                                                        감사합니다.<br>
                                                        프리미어티켓(한국)070-7779-9614<br>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="accordion-item">
                                            <h2 class="accordion-header" id="headingThree">
                                                <button class="accordion-button collapsed align-items-lg-center align-items-start d-flex flex-column flex-lg-row" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                                    <div class="accord-numb">9.</div> <span class="accord-header">경기 일정은 언제 확정 되나요?</span>
                                                </button>
                                            </h2>
                                            <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                                                <div class="accordion-body">
                                                    <p class="fs-14">
                                                        ...
                                                        경기 일정은 일반적으로 킥오프 시점 기준 약 40~50일 전 확정 됩니다.<br>
                                                        경기 일정은 잉글랜드 FA 및 구단 협의를 통해 결정 되므로 정확한 시점과 내용은 사전 확정이 어렵습니다.<br>
                                                        경기 일정이 100% 확정 되는 경우는 없습니다. 관심을 갖고 경기 전 까지 일정을 체크해 주시길 부탁드립니다.<br>
                                                        이미 확정 된 경기도 컵 경기 일정과 구단 사정, 대중교통 파업 등 다양한 요인에 영향을 받아 재변경 될 수 있습니다.<br>
                                                        따라서 모든 조건을 예상하여 여행일정을 구성하는 것은 불가능합니다.<br>
                                                        전반기는 대체로 일정 변경 빈도가 낮으며, 되도록 해당 시기 관전하는 팀이 있는 도시 주말 체류를 권장하고 있습니다.<br>
                                                        감사합니다.<br>
                                                        프리미어티켓 올림<br>
                                                    </p>
                                                </div>
                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="row r-content-2">
                            <div class="mt-3">
                                <div class="table-full d-none d-lg-block">
                                    <table class="table table-bordered text-center">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="" onclick="location.href='faq-detail.html'">
                                                <td><button type="submit" class="btn btn-sm btn-danger">공지</button></td>
                                                <td class="text-start">2매 이상 예약 시 좌석은 어떤 형식으로 구성 되나요?</td>
                                                <td>2024-04-23</td>
                                                <td>1986</td>
                                            </tr>
                                            <tr class="" onclick="location.href='faq-detail.html'">
                                                <td><button type="submit" class="btn btn-sm btn-danger">공지</button></td>
                                                <td class="text-start">페이팔(paypal) 신용카드 결제 안내</td>
                                                <td>2024-04-23</td>
                                                <td>1986</td>
                                            </tr>
                                            <tr class="" onclick="location.href='faq-detail.html'">
                                                <td>9</td>
                                                <td class="text-start">경기 일정은 언제 확정 되나요?</td>
                                                <td>2024-04-23</td>
                                                <td>1986</td>
                                            </tr>
                                        </tbody>
                                ...
                                <div class="d-block d-lg-none pt-1">
                                    <div class="d-flex flex-column" onclick="location.href='faq-detail.html'">
                                        <div class="mt-1 border-top border-bottom">
                                            <div class="game-list d-flex gap-4 fw-bold p-2">
                                                <div><button type="submit" class="btn btn-sm btn-danger">공지</button> 2매 이상 예약 시 좌석은 어떤 형식으로 구성 되나요?</div>
                                            </div>
                                            <div class="d-flex justify-content-end gap-1 text-black-50 p-1">
                                                <div>작성일 <span class="">2024-04-23</span></div>
                                                <div>|</div>
                                                <div>조회 <span class="">1986</span></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="d-flex flex-column" onclick="location.href='faq-detail.html'">
                                        <div class="mt-1 border-top border-bottom">
                                            <div class="game-list d-flex gap-4 fw-bold p-2">
                                                <div><button type="submit" class="btn btn-sm btn-danger">공지</button> 페이팔(paypal) 신용카드 결제 안내</div>
                                            </div>
                                            <div class="d-flex justify-content-end gap-1 text-black-50 p-1">
                                                <div>작성일 <span class="">2024-04-23</span></div>
                                                <div>|</div>
                                        ...
                                        <div class="mt-1 border-top border-bottom">
                                            <div class="game-list d-flex gap-4 fw-bold p-2">
                                                <div class="align-items-center d-flex gap-2">
                                                    9
                                                    <div data-bs-toggle="modal" data-bs-target="#exampleModal">경기 일정은 언제 확정 되나요?</div>
                                                </div>
                                            </div>
                                            <div class="d-flex justify-content-end gap-1 text-black-50 p-1">
                                                <div>작성일 <span class="">2024-04-23</span></div>
