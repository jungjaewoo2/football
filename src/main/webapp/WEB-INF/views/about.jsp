            ...
            <div class="inner-page-banner banner-bg">
                <div class="container">
                    <div class="banner-content">
                        ...
                        <h1 class="banner-heading">유로풋볼투어</h1>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="r-content-2">
                            <div class="row">
                                <div class="col-12 d-flex flex-column">
                                    <div class="about-thumb justify-content-center">
                                        <div class="img2 w-100"><a class="w-100" href="#"><img src="assets/images/about/about-img01.png" alt="about-thumb" width="100%"></a></div>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="contents d-flex flex-column flex-lg-row gap-5 justify-content-between">
                                        <div class="section-title-area section-title-area1 text-start">
                                            <h1 class="section-title text-center"><span>믿을 수 있는 여행사</span></h1>
                                            <p class="">
                                                유로풋볼투어는 결제 당일 서비스 항목에 대한 증빙서류 제공을 원칙으로 합니다.<br>
                                                항공의 경우 결제 당일 발권, e티켓을 제공하며 해당 항공사 홈페이지에서 실제 예약 유무를 직접 확인 할 수 있습니다.<br>
                                                숙소 및 축구 티켓 등 겨제 후 서비스 업체로부터 예약 확인증을 발급받아 결제 당일 전달드립니다.
                                            </p>
                                        </div>
                                        <div class="section-title-area section-title-area1 text-start">
                                            <h1 class="section-title text-center"><span>원칙을 지키는 여행사</span></h1>
                                            <p class="">
                                                유로풋볼투어는 여행자의 목적에 맞는 여행상품을 기획하고 여행 전 계약서를 배부 및 서명 합니다.<br>
                                                소액의 계약금을 포함한 계약에 필요한 필수 항목 결제 후 확인증을 배부합니다.<br>
                                                여행 한달 전 잔금을 결제하며 그 사이 에치금 또는 임치(任置)에 필요한 금액을 요구하지 않습니다.
                                            </p>
                                        </div>
                                        <div class="section-title-area section-title-area1 text-start">
                                            <h1 class="section-title text-center"><span>안전한 여행사</span></h1>
                                            <p class="">
                                                유로풋볼투어는 법령에 의거하여 여행자 보증보험을 1년마다 갱신합니다.<br>
                                                여행자는 계약한 서비스를 제공받지 못한 경우 최고 3천만원 한도에서 보상받으실 수 있습니다.<br>
                                                한편 여행 시 발생할 수 있는 불의의 상황을 대비하여 모든 여행자들은 여행자 보험에 가입합니다.<br>
                                                보험은 상해 및 병원 진료 시 기준에 맞춰 보상 받을 수 있습니다.
                                            </p>
                                        </div>
                                    </div>
                                </div>
