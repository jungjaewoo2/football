                            ...
                            <div class="row">
                                <div class="col-xl-4 col-md-6">
                                    <div class="event-single">
                                        <div class="event-picture"><img src="assets/images/event/event1.jpg" alt="event-picture">
                                            <div class="event-date-floating gap-1">
                                                <span class="day">by.</span>
                                                <span class="month">고태화</span>
                                                <span class="year">57 views</span>
                                            </div>
                                        </div>

                                        <div class="contents">
                                            <a href="board-detail.html" class="event-title">[2024-2025 EPL]</a>
                                            <p>맨시티 vs 첼시, 토트넘 vs 레스터시티 경기 관전후기</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-4 col-md-6">
                                    <div class="event-single">
                                        <div class="event-picture"><img src="assets/images/event/event2.jpg" alt="event-picture">
                                            <div class="event-date-floating gap-1">
                                                <span class="day">by.</span>
                                                <span class="month">구상회</span>
                                                <span class="year">38 views</span>
                                            </div>
                                        </div>

                                        <div class="contents">
                                            <a href="board-detail.html" class="event-title">[2024-2025 EPL]</a>
                                            <p>맨유 vs 에버튼 경기 관전후기</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-4 col-md-6">
                                    <div class="event-single">
                                        <div class="event-picture"><img src="assets/images/event/event3.jpg" alt="event-picture">
                                            <div class="event-date-floating gap-1">
                                                <span class="day">by.</span>
                                                <span class="month">김순영</span>
                                                <span class="year">37 views</span>
                                            </div>
                                        </div>

                                        <div class="contents">
                                            <a href="board-detail.html" class="event-title">[2024-2025 EPL]</a>
                                            <p>토트넘 vs 레스터시티 경기 관전후기</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-4 col-md-6">
                                    <div class="event-single">
                                        <div class="event-picture"><img src="assets/images/event/event4.jpg" alt="event-picture">
                                            <div class="event-date-floating gap-1">
                                                <span class="day">by.</span>
                                                <span class="month">박영해</span>
                                                <span class="year">161 views</span>
                                            </div>
                                        </div>

                                        <div class="contents">
                                            <a href="board-detail.html" class="event-title">[2024-2025 EPL]</a>
                                            <p>리버풀 vs 아스톤빌라 경기 관전후기</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-4 col-md-6">
                                    <div class="event-single">
                                        <div class="event-picture"><img src="assets/images/event/event5.jpg" alt="event-picture">
                                            <div class="event-date-floating gap-1">
                                                <span class="day">by.</span>
                                                <span class="month">황성우</span>
                                                <span class="year">107 views</span>
                                            </div>
                                        </div>

                                        <div class="contents">
                                            <a href="board-detail.html" class="event-title">[2024-2025 EPL]</a>
                                            <p>토트넘 vs 웨스트햄 경기 관전후기</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-4 col-md-6">
                                    <div class="event-single">
                                        <div class="event-picture"><img src="assets/images/event/event6.jpg" alt="event-picture">
                                            <div class="event-date-floating gap-1">
                                                <span class="day">by.</span>
                                                <span class="month">전수연</span>
                                                <span class="year">94 views</span>
                                            </div>
                                        </div>
                                ...
                                <div class="col-xl-4 col-md-6">
                                    <div class="event-single">
                                        <div class="event-picture"><img src="assets/images/event/event7.jpg" alt="event-picture">
                                            <div class="event-date-floating gap-1">
                                                <span class="day">by.</span>
                                                <span class="month">서이삭</span>
                                                <span class="year">145 views</span>
                                            </div>
                                        </div>

                                        <div class="contents">
                                            <a href="board-detail.html" class="event-title">[2024-2025 EPL]</a>
                                            <p>맨유 vs 토트넘 경기 관전후기</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-4 col-md-6">
                                    <div class="event-single">
                                        <div class="event-picture"><img src="assets/images/event/event8.jpg" alt="event-picture">
                                            <div class="event-date-floating gap-1">
                                                <span class="day">by.</span>
                                                <span class="month">라해진</span>
                                                <span class="year">122 views</span>
                                            </div>
                                        </div>

                                        <div class="contents">
                                            <a href="board-detail.html" class="event-title">[2024-2025 EPL]</a>
                                            <p>토트넘 vs 브렌트포드 경기 관전후기</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-4 col-md-6">
                                    <div class="event-single">
                                        <div class="event-picture"><img src="assets/images/event/event9.jpg" alt="event-picture">
                                            <div class="event-date-floating gap-1">
                                                <span class="day">by.</span>
                                                <span class="month">이동주</span>
                                                <span class="year">112 views</span>
                                            </div>
                                        </div>

                                        <div class="contents">
                                            <a href="board-detail.html" class="event-title">[2024-2025 EPL]</a>
                                            <p>토트넘 vs 아스널 경기 관전후기</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
